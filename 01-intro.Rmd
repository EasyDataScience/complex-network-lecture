...
Cũng với mạng không hướng, nếu có $m$ cạnh thì tổng số bậc của tất cả các đỉnh sẽ là $2m$. Ví dụ như với mạng 500 sân bay lớn nhất của Mỹ trong hình \@ref(eq:USairport) ta có các thông số sau:
...
```{r USAirport_500_deg, fig.align = 'center', out.width = "80%", fig.cap = "Bậc của mạng 500 sân bay tuân theo phân bố hàm mũ (phần đuôi) giống như nhiều mạng lưới thực tế khác", echo = FALSE}
